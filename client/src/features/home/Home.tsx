      ...
      <div className="page-content bg-white">
              ...
              <ul>
                ...
                >
                  ...
                  <div
                    ...
                    style={{"zIndex":"5","backgroundColor":"rgba(2, 0, 11, 0.80)","borderColor":"rgba(0, 0, 0, 0)","borderWidth":"0px"}}
                  >
                    {" "}
                  </div>
                  ...
                  <div
                    ...
                    data-paddingbottom="[0,0,0,0]"
                    data-paddingleft="[0,0,0,0]"
                    style={{"zIndex":"7","whiteSpace":"nowrap","color":"#fff","fontFamily":"rubik","fontSize":"18px","fontWeight":"400"}}
                  ...
                  <div
                    ...
                    style={{"zIndex":"8","whiteSpace":"nowrap","outline":"none","boxShadow":"none","boxSizing":"border-box","MozBoxSizing":"border-box","WebkitBoxSizing":"border-box","cursor":"pointer","backgroundColor":"var(--primary) !important","border":"0","borderRadius":"30px","marginRight":"5px"}}
                  >
                    READ MORE{" "}
                  </div>
                  <div
                    ...
                    data-paddingbottom="[12,12,12,12]"
                    data-paddingleft="[30,35,35,15]"
                    style={{"zIndex":"8","whiteSpace":"nowrap","outline":"none","boxShadow":"none","boxSizing":"border-box","MozBoxSizing":"border-box","WebkitBoxSizing":"border-box","cursor":"pointer","borderRadius":"30px"}}
                  >
                    CONTACT US
                  </div>
                </li>
                ...
                >
                  ...
                  <div
                    ...
                    data-paddingbottom="[0,0,0,0]"
                    data-paddingleft="[0,0,0,0]"
                    style={{"zIndex":"7","whiteSpace":"nowrap","textTransform":"uppercase","color":"#fff","fontFamily":"rubik","fontSize":"18px","fontWeight":"400"}}
                  >
                    Batter Education For A Better
                  </div>
        ...
        <div className="content-block">
                ...
                <div className="col-lg-4 col-md-4 col-sm-6">
                  <div className="service-bx">
                    ...
                    <div className="info-bx text-center">
                      ...
                      <h4>
                        <a href="link">Best Industry Leaders</a>
                      </h4>
                      <a href="link" className="btn radius-xl">
                        View More
                      </a>
                    </div>
                  </div>
                ...
                <div className="col-lg-4 col-md-4 col-sm-6">
                  <div className="service-bx">
                    ...
                    <div className="info-bx text-center">
                      ...
                      <h4>
                        <a href="link">Learn Courses Online</a>
                      </h4>
                      <a href="link" className="btn radius-xl">
                        View More
                      </a>
                ...
                <div className="col-lg-4 col-md-4 col-sm-12">
                  <div className="service-bx m-b0">
                    ...
                    <div className="info-bx text-center">
                      ...
                      <h4>
                        <a href="link">Book Library & Store</a>
                      </h4>
                      <a href="link" className="btn radius-xl">
                        View More
                      </a>
                ...
                <div className="courses-carousel owl-carousel owl-btn-1 col-12 p-lr0">
                  <div className="item">
                    <div className="cours-bx">
                      ...
                      <div className="info-bx text-center">
                        <h5>
                          <a href="link">Introduction EduChamp – LMS plugin</a>
                        </h5>
          ...
          <div
            ...
            style={{
              backgroundImage:
                `url(assets/images/background/bg1.jpg)`,
            }}
          >
            <div className="container">
              <div className="row">
                      ...
                      <div className="info-bx d-flex">
                        ...
                        <div className="event-info">
                          <h4 className="event-title">
                            <a href="link">Education Autumn Tour 2019</a>
                          </h4>
                          <ul className="media-post">
                            <li>
                              <a href="link">
                                <i className="fa fa-clock-o"></i> 7:00am 8:00am
                              </a>
                            </li>
                            <li>
                              <a href="link">
                                <i className="fa fa-map-marker"></i> Berlin,
                                Germany
                              </a>
                            </li>
                          </ul>
                  ...
                  <div className="recent-news">
                    ...
                    <div className="info-bx">
                      ...
                      <div className="post-extra">
                        ...
                        <a href="link" className="comments-bx">
                  ...
                  <div className="col-4 col-lg-4 col-md-4 col-sm-4">
                    <div className="widget footer_widget">
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="blog-classNameic-grid.html">Blog</a>
                        </li>
                        <li>
                          <a href="portfolio.html">Portfolio</a>
                        </li>
